...
/**
 * Template Name: Add_New_Post_Per_Users
...
<main id="page-content" class="l-main"<?php echo $usbid_container_attribute . ( ( us_get_option( 'schema_markup' ) ) ? ' itemprop="mainContentOfPage"' : ''); ?>>
	    ...
	    <div class="g-cols vc_row via_grid cols_1 laptops-cols_inherit tablets-cols_inherit mobiles-cols_1 valign_top type_default">
	      <div class="wpb_column vc_column_container">
	        <div class="vc_column-inner">
	          <div class="g-cols wpb_row us_custom_595d2d28 via_grid cols_1 laptops-cols_inherit tablets-cols_inherit mobiles-cols_1 valign_top type_default">
	            <div class="wpb_column vc_column_container">
	              <div class="vc_column-inner">
	                <h2 class="w-text us_custom_8b3d6790 has_text_color"><span class="w-text-h"><i class="fas fa-user"></i><span class="w-text-value">My Account</span></span></h2>
	                <div class="w-separator us_custom_bf81054c size_small with_line width_default thick_1 style_solid color_border align_center">
	                  <div class="w-separator-h"></div>
	                </div>
	                <div class="w-menu layout_hor style_links us_menu_1" style="--main-gap:1.5rem;--main-ver-indent:0.8em;--main-hor-indent:0.8em;">
	                  <ul id="menu-my-account" class="menu">
	                    <li id="menu-item-10383" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-10383"><a href="/my-events/">My Events</a></li>
	                    <li id="menu-item-10388" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-10388"><a href="/add-new-event/">Add New Event</a></li>
	                    <li id="menu-item-22290" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-22290"><a href="/add-new-location/" target="_blank">Add New Location</a></li>
	                  </ul>
	                  <style>
	                    .us_menu_1 .menu>li>a {
  ...
  acf_form(array(
    ...
    'return'		    => home_url('new-event-added'),
    'submit_value'	=> 'Send'
  ));
