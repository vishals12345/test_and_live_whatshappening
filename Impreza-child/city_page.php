...
<main id="page-content" class="l-main"<?php echo $usbid_container_attribute . ( ( us_get_option( 'schema_markup' ) ) ? ' itemprop="mainContentOfPage"' : ''); ?>>
	...
	*/
	...
	$eventcity_slug = get_query_var( 'eventcity' );
	$term = get_term_by( 'slug', $eventcity_slug, 'post_tag' ); // Replace 'city_taxonomy' with your taxonomy name.
	if ( $term )     $term_description = term_description( $term->term_id, 'city_taxonomy' );
	...
	[us_image image="9144" has_ratio="1" ratio="custom" ratio_width="20" ratio_height="6" align="center" size="full"]'.'
	[/vc_column_inner]'.'
	[/vc_row_inner]'.'
	[/vc_column]'.'
	[/vc_row]'.'
	[vc_row height="small" columns="4-1"]'.'
	[vc_column width="4/5"]'.'
	[vc_row_inner css="%7B%22default%22%3A%7B%22margin-top%22%3A%22-20px%22%7D%7D"]'.'
	[vc_column_inner width="1/1"]'.'
	[vc_column_text css="%7B%22default%22%3A%7B%22text-align%22%3A%22left%22%2C%22font-size%22%3A%2213px%22%7D%7D"]'.'<a href="'.get_site_url().'">Home</a> > '.ucfirst(get_query_var( 'eventcity' )).'
	[/vc_column_text]'.'
	[/vc_column_inner]'.'
	[/vc_row_inner]'.'
	[us_separator size="small"]'.'
	[us_additional_menu source="menu_middle" layout="hor" css="%7B%22default%22%3A%7B%22font-size%22%3A%2214px%22%2C%22border-style%22%3A%22solid%22%2C%22border-top-width%22%3A%221px%22%2C%22border-bottom-width%22%3A%221px%22%2C%22border-color%22%3A%22%23ff1c42%22%7D%7D"]'.'
	[us_separator size="small"]'.'
	[vc_column_text]'.$term_description.'[/vc_column_text]'.'
	[us_separator size="small"]'.'
	[us_text text="Last added" tag="h2" css="%7B%22default%22%3A%7B%22color%22%3A%22_header_middle_bg%22%2C%22background-color%22%3A%22_alt_content_bg%22%2C%22margin-top%22%3A%2210px%22%2C%22padding-left%22%3A%2215px%22%2C%22padding-top%22%3A%2212px%22%2C%22padding-bottom%22%3A%2210px%22%7D%7D"]'.'
	[us_separator size="small"]'.'
	[vc_column_text]'.'
	[apf_display_posts]'.'
	[/vc_column_text]'.'
	[us_separator size="small"]'.'
	[us_text text="Locations" link="%7B%22url%22%3A%22%22%7D" tag="h2" css="%7B%22default%22%3A%7B%22color%22%3A%22_header_middle_bg%22%2C%22background-color%22%3A%22_alt_content_bg%22%2C%22margin-top%22%3A%2210px%22%2C%22padding-left%22%3A%2215px%22%2C%22padding-top%22%3A%2212px%22%2C%22padding-bottom%22%3A%2210px%22%7D%7D"]'.'
	[vc_column_text]'.'
	[apf_display_locations cityFilter="off"]'.'
	[/vc_column_text]'.'
	[/vc_column]'.'
	[vc_column sticky="1" css="%7B%22default%22%3A%7B%22margin-top%22%3A%2250px%22%7D%7D" width="1/5"]'.'
	[vc_row_inner css="%7B%22default%22%3A%7B%22margin-top%22%3A%22-20px%22%7D%7D"]'.'
	[vc_column_inner width="1/1"]'.'
	[us_html]'.'JTVCYWRzZW5zZV92ZXJ0aWNhbF9hZCU1RA==
	[/us_html]'.'
	[/vc_column_inner]'.'
	[/vc_row_inner]'.'
	[/vc_column]'.'
...
//[us_grid taxonomy_post_tag="'.get_query_var( 'eventcity' ).'" items_quantity="12" pagination="ajax" items_layout="9990" columns="4"]
...
jQuery(document).ready(function($) {
    $('.g-placeholder').attr('src', '<?php echo get_field('image',$term);  ?>');
});
